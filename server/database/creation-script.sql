...
VALUES
  ...
  ('Zapatillas de running', 'Zapatillas ligeras para correr', 89.99, 0.1, 100, 30, 15, 3, 'images/zapatillas_adidas.webp', 3),
  ('Vestido floral', 'Vestido de estilo floral para ocasiones especiales', 69.99, 1, 30, 5, 3, 4, 'images/vestido_floral.webp', 1),
  ('Pantalón de mezclilla', 'Pantalón de mezclilla clásico para hombres', 49.99, 0.05, 60, 15, 5, 1, 'images/pantalon_de_mezclilla.webp', 2),
  ('Shorts de playa', 'Shorts de playa para hombres', 24.99, 1, 90, 20, 10, 1, 'images/shorts_de_playa.webp', 3),
  ('Blusa de encaje', 'Blusa de encaje elegante para mujeres', 39.99, 0.1, 50, 10, 5, 2, 'images/blusa_de_encaje.webp', 1),
  ('Zapatos de vestir', 'Zapatos de vestir clásicos para hombres', 79.99, 1, 40, 10, 5, 1, 'images/zapatos_de_vestir.webp', 2),
  ('Blusa estampada', 'Blusa estampada de manga larga', 29.99, 0.05, 70, 15, 5, 2, 'images/blusa_estampada.webp', 3),
  ('Gorra de béisbol', 'Gorra de béisbol con diseño moderno', 19.99, 1, 100, 20, 10, 6, 'images/gorra_de_beisbol.webp', 1),
  ('Traje de baño', 'Traje de baño de dos piezas para mujeres', 49.99, 0.1, 60, 10, 5, 5, 'images/traje_de_baño.webp', 2),
  ...
  ('Jersey de punto', 'Jersey de punto cálido y suave', 59.99, 0.15, 50, 10, 5, 5, 'images/jersey_de_punto.webp', 3),
  ('Camisa de manga larga', 'Camisa de manga larga para hombres', 39.99, 1, 70, 15, 5, 13, 'images/camisa_de_manga_larga.webp', 1),
  ('Sandalias de playa', 'Sandalias cómodas para uso en la playa', 29.99, 0.05, 80, 20, 10, 10, 'images/sandalias_de_playa.webp', 2),
  ('Vestido de verano', 'Vestido de verano ligero y fresco', 49.99, 1, 40, 5, 3, 4, 'images/vestido_de_verano.webp', 3),
  ('Pantalones de vestir', 'Pantalones de vestir elegantes para hombres', 69.99, 0.1, 60, 15, 5, 3, 'images/pantalones_de_vestir.webp', 1),
  ('Sudadera con cierre', 'Sudadera con cierre para uso casual', 44.99, 1, 90, 20, 10, 2, 'images/sudadera_con_cierre.webp', 2),
  ('Zapatos casuales', 'Zapatos casuales cómodos para hombres', 69.99, 0.05, 50, 10, 5, 6, 'images/zapatos_casuales.webp', 3),
  ('Vestido de encaje', 'Vestido de encaje elegante para ocasiones especiales', 89.99, 1, 30, 5, 3, 4, 'images/vestido_de_encaje.webp', 1),
  ('Jeans desgastados', 'Jeans desgastados de estilo moderno', 59.99, 0.1, 70, 15, 5, 5, 'images/jeans_desgastados.webp', 2),
  ('Blusa de seda', 'Blusa de seda suave y elegante', 49.99, 1, 80, 20, 10, 2, 'images/blusa_de_seda.webp', 3),
  ('Chaqueta deportiva', 'Chaqueta deportiva ligera para hombres', 79.99, 0.15, 100, 30, 15, 3, 'images/chaqueta_deportiva.webp', 1),
  ('Vestido de noche', 'Vestido de noche elegante para ocasiones especiales', 129.99, 1, 30, 5, 3, 4, 'images/vestido_de_noche.webp', 2),
  ('Polo clásico', 'Camisa polo de manga corta para hombres', 34.99, 1, 70, 15, 5, 1, 'images/polo_clásico.webp', 3),
  ('Sudadera estampada', 'Sudadera estampada con diseño único', 54.99, 0.05, 90, 20, 10, 2, 'images/sudadera_estampada.webp', 1),
  ...
  ('Sneakers deportivos', 'Sneakers deportivos para entrenamiento', 89.99, 0.1, 100, 30, 15, 13, 'images/sneakers_deportivos.webp', 3),
  ('Blazer formal', 'Blazer formal de alta calidad', 129.99, 1, 30, 5, 3, 4, 'images/blazer_formal.webp', 1),
  ('Pantalones cortos de playa', 'Pantalones cortos de playa para hombres', 39.99, 0.05, 60, 15, 5, 1, 'images/pantalones_cortos_de_playa.webp', 2),
  ...
  ('Botas de cuero', 'Botas de cuero duraderas para hombres', 89.99, 0.2, 40, 10, 5, 1, 'images/botas_de_cuero.webp', 2),
  ('Blusa de lunares', 'Blusa de manga larga con estampado de lunares', 29.99, 0.05, 70, 15, 5, 2, 'images/blusa_de_lunares.webp', 3),
  ('Gorra de moda', 'Gorra de moda con diseño moderno', 19.99, 1, 100, 20, 10, 3, 'images/gorra_de_moda.webp', 1),
  ('Traje de baño de una pieza', 'Traje de baño de una pieza para mujeres', 49.99, 0.1, 60, 10, 5, 4, 'images/traje_de_baño_de_una_pieza.webp', 2),
  ...
  ('Jersey de cuello alto', 'Jersey de cuello alto para hombres', 59.99, 0.15, 50, 10, 5, 5, 'images/jersey_de_cuello_alto.webp', 3),
  ...
  ('Pantalones de vestir ajustados', 'Pantalones de vestir ajustados para hombres', 79.99, 0.1, 60, 15, 5, 7, 'images/chaqueta_de_invierno.webp', 1),
  ('Sudadera ligera', 'Sudadera ligera para uso casual', 44.99, 1, 90, 20, 10, 2, 'images/sudadera_ligera.webp', 2),
  ('Zapatos casuales de cuero', 'Zapatos casuales de cuero para hombres', 69.99, 0.05, 50, 10, 5, 9, 'images/zapatos_casuales_de_cuero.webp', 3),
  ...
  ('Jeans de estilo vintage', 'Jeans de estilo vintage para hombres', 59.99, 0.1, 70, 15, 5, 11, 'images/jeans_de_estilo_vintage.webp', 2),
  ...
  ('Chaqueta deportiva transpirable', 'Chaqueta deportiva transpirable para hombres', 79.99, 0.15, 100, 30, 15, 3, 'images/chaqueta_deportiva_transpirable.webp', 1),
  ...
  ('Sneakers de moda', 'Sneakers de moda para uso diario', 59.99, 0.05, 80, 20, 10, 3, 'images/sneakers_deportivos.webp', 3),
  ...
  ('Chaqueta de punto', 'Chaqueta de punto cálida y suave', 69.99, 0.1, 60, 15, 5, 5, 'images/chaqueta_de_punto.webp', 3),
  ...
  ('Vestido estampado de verano', 'Vestido estampado de verano para ocasiones informales', 49.99, 0.1, 60, 10, 5, 4, 'images/vestido_estampado_de_verano.webp', 3);
