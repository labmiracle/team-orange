export default function CartIconSVG({
    width = 60,
    height = width,
}: {
    width?: number | string;
    ...
    return (
        <div style={{ width: width, height: height }}>
            <svg version="1.1" viewBox="0 0 20 20">
                <g fill="currentColor" fillRule="evenodd" id="Page-1" stroke="currentColor" strokeWidth="1">
                    <g fill="currentColor" id="Core" transform="translate(-212.000000, -422.000000)">
